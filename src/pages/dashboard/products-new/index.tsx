...
import { ProductListTable } from '../../../components/dashboard/product-new/product-new-list-table';
...
const ProductListNew: NextPage = () => {
  ...
  const { user } = useAuth(); 
  // if (user.formActive!= null ) {user.formActive = false } 
  return (
    <>
      <Head>
        <title>
            ...
            >
              <Grid item>
                <Typography variant="h4">
                  Productos a enviar a Gessa
                </Typography>
              </Grid>
              <Grid item>
                <NextLink
                  href="/dashboard/products-new/new"
                  passHref
                >
                  <Button
                    component="a"
