    ...
    <>
      ...
      >
        ...
        >
          ...
          <Box sx={{ flexGrow: 1,   backgroundImage: 'url(/static/AmimedBanner.png)',   backgroundPosition: 'left',
                border: '0px solid black',
                padding: '25px', backgroundRepeat: 'no-repeat',
                backgroundSize: 'cover',}}>    {/* AQUI VA EL COLOR DE AMIMED */}
