...
export const ProductListChgTable: FC<ProductListTableProps> = (props) => {
  const {
    onPageChange,
    onRowsPerPageChange,
    page,
                ...
                <Fragment key={arti.ArticuloID}>
                  ...
                  >
                   ...
                   <TableCell >
                    ...
                    <TableCell>
                      <SeverityPill color={arti.status == 'VALIDADO  ' ? 'error' : arti.status == 'ASISTENTE ' ? 'success' : 'secondary'}>
                        {arti.status}
                      </SeverityPill>
                      </TableCell>
                    <TableCell align="center">
                    <NextLink
                          href={`/dashboard/products-new/productCHG/${arti.ArticuloID}`}
