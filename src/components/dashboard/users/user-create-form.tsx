...
export const UserCreateForm: FC = (props) => {
  ...
  const userTypes = [{ value: "0", text: "ADMIN" }, { value: "1", text: "ADC" }, { value: "2", text: "Asistente" }, { value: "3", text: "Proveedor" }, { value: "4", text: "Gerencia" }, { value: "6", text: "Proveedor No Eway" }]
