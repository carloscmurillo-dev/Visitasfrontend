...
export const ProveedorEditForm: FC<ProveedorEditFormProps> = (props) => {
  ...
  useEffect(() => {
    ...
    setcantonDistritoProvincia(String(proveedor.canton_id))
    setCategoryIdSelected(proveedor.categoria_id)
...
///////////////////////////////////
  ...
  const formik = useFormik({
    initialValues: {
      ...
      proveedor_id: proveedor.proveedor_id || 0,
      proveedor_dsc: proveedor.proveedor_dsc || '',
      gln: proveedor.gln || '',
      CedJuridica: proveedor.CedJuridica  || '',
      RazonSocial: proveedor.RazonSocial || '',
      RepreLegal: proveedor.RepreLegal|| '',
      GerenteGeneral: proveedor.GerenteGeneral|| '',
      GerenteVentas: proveedor.GerenteVentas || '',
      AgenteVentas: proveedor.AgenteVentas || '', 
      ContactoFinanc: proveedor.ContactoFinanc || '',
      Direccion: proveedor.Direccion || '',
      Barrio: proveedor.Barrio || '',
      Tel1 : proveedor.Tel1 || '',
      Tel2 : proveedor.Tel2 || '',
      NombreContactoFactElec : proveedor.NombreContactoFactElec || '',
      TelContactoFactElec : proveedor.TelContactoFactElec || '',
      EmailContactoFactElec : proveedor.EmailContactoFactElec || '',
      EmailReciboContactoFactElec : proveedor.EmailReciboContactoFactElec || '',
      CantidadLinesXFactura : proveedor.CantidadLineasXFactura || 0,
      AceptaDevoluc: proveedor.AceptaDevoluc || false,
      OrdenCompra: proveedor.OrdenCompra || false,
      DescuentoFijo : proveedor.DescuentoFijo || false,
      PorDescuentoFijo: proveedor.PorDescuentofijo || 0,
      DescuentoConfidencial: proveedor.DescuentoConfidencial || false,
      PorDescuentoConfidencial: proveedor.PorcDescuentoConfidencial ||  0,
      DescuentoIntroduccion: proveedor.DescuentoIntroduccion || false,
      PorDescuentoIntroduccion: proveedor.PorcDescuentoIntroduccion || 0,
      PartDinamicasComerciales: proveedor.PartDinamicasComerciales || false,
      PartEspaciosPromocionales: proveedor.PartDinamicasComerciales || false,
      PartDisplays: proveedor.PartDisplays || false,
      FrecuenciaVisitaTiendas: proveedor.FrecuenciaVisitaTiendas || 0,
      AportaCodigoCABYS: proveedor.AportaCodigoCABYS || false,
      CodigoCABYS : proveedor.CodigoCABYS || '',
      DocEntregaFacElect : proveedor.DocEntregaFacElect || false,
      DocEntregaGuiaDespacho : proveedor.DocEntregaGuiaDespacho || false,
      CantidadLineasXFactura : proveedor.CantidadLineasXFactura || 0,
      PorDescuentofijo : proveedor.PorDescuentofijo || 0,
      PorcDescuentoConfidencial : proveedor.PorcDescuentoConfidencial || 0,
      PorcDescuentoIntroduccion : proveedor.PorcDescuentoIntroduccion || 0,
      TipoEntrega : proveedor.TipoEntrega || 1,
      canton_id : proveedor.canton_id || 1,
      ActividadEconomicaID : proveedor.ActividadEconomicaID ||  1 ,
      PlazoPagoID : proveedor.PlazoPagoID || 1,
